  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
<form action="{{ asset('abari_jurnal/edit_proses') }}" method="POST">
@csrf
<div class="form-group row">
    <label class="col-sm-2 col-form-label">ID Jurnal</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="ID Jurnal" name="id_jurnal" value="<?php echo $akun->id_jurnal ?>" disabled>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
      <select class="form-control" id="exampleFormControlSelect1" name="jns_jurnal" value="<?php echo $akun->jns_jurnal ?>">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
      <input id="date" class="form-control" placeholder="Tanggal" name="tanggal" value="<?php echo $akun->tanggal ?>">
    </div>
</div>
